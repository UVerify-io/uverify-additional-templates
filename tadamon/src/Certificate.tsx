...
import { CircularHash, formatDate, timestampToDateTime } from './utils';
...
class TadamonTemplate extends Template {
  ...
  public render(
    ...
    let explorerUrlPrefix = this.uverifyConfig?.networkType + '.';
    if (this.uverifyConfig?.networkType === 'mainnet') {
      explorerUrlPrefix = '';
    }

    const csoName = metadata.cso_name || '';
    const registrationCountry = metadata.registration_country
    ...
    return (
      <>
        <link
          ...
          rel="stylesheet"
        />
        <div className="rounded-[25px] sm:rounded-[40px] my-12 relative pt-12 px-12 bg-[#eeeff2] font-['Manrope',sans-serif] text-[#1f242b] w-10/12 md:w-3/4 max-w-[800px] max-h-[680px] overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start">
            <div className="flex w-[200px] md:w-2/3 flex-col items-center sm:items-start justify-between">
              <div className="flex flex-col items-start justify-center mt-8 sm:mt-16">
                ...
                <p className="text-lg text-[#4E5661] mt-4">
                  has been awarded a
                </p>
          ...
          <div className="flex flex-row items-center">
            ...
            <div className="flex w-full md:w-1/3 items-center justify-center">
              <img
                src={plantsLogo}
                alt="Plants Logo"
                className="md:absolute md:bottom-0 md:w-[5/7] max-w-[200px] scale-x-[-1]"
              />
            </div>
          </div>
        </div>
